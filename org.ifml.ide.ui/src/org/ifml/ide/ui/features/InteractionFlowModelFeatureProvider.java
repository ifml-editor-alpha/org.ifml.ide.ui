...
/**
 * The IFML Graphiti feature provider for interaction flow models.
 */
public final class InteractionFlowModelFeatureProvider extends DefaultFeatureProviderWithPatterns {
     ...
     */
    public InteractionFlowModelFeatureProvider(IDiagramTypeProvider dtp) {
        super(dtp);
