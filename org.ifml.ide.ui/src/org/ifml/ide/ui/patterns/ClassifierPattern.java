...
class ClassifierPattern extends AbstractIfmlShapePattern<Classifier> {
    ...
    public boolean layout(ILayoutContext context) {
        Classifier classifier = (Classifier) getBusinessObjectForPictogramElement(context.getPictogramElement());
        EList<? extends EObject> children = classifier.getStructuralFeatures();
        ...
        /* updates the text */
        text.setValue(String.format("%s %s", getStereotype(), Objects.firstNonNull(classifier.getName(), "Unknown name")));
